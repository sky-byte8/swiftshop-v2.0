package com.swiftshop.item.service.impl;
...
import com.swiftshop.item.domain.dto.OrderDetailDTO;
import com.swiftshop.item.domain.po.Item;
import com.swiftshop.item.mapper.ItemMapper;
...
public class ItemServiceImpl extends ServiceImpl<ItemMapper, Item> implements IItemService {
    ...
    public void deductStock(List<OrderDetailDTO> items) {
        String sqlStatement = "com.swiftshop.item.mapper.ItemMapper.updateStock";
        boolean r = false;
        try {
